    ...
    render() {
        return html`            
            <div class = "column is-full">
                <h1 class=" title is-size-1 has-text-centered  has-text-primary is-italic has-text-weight-bold  ">TALENTSEA</h1>
            </div>            
            <div class="columns is-mobile is-centered">   
                <div class="column is-11">
                    <hr style =" background: linear-gradient(to right, hsl(171, 100%, 41%) 40%, hsl(217, 71%, 53%) 60%);  height: 3px ">
                ...
                <div class = " column is-10">
                    <div class = " columns is-mobile" >
                        <div class = " column is-5">
                            <div style = " box-shadow: -2px 2px 3px hsl(171, 100%, 41%), 0 0 0 1px hsl(171, 100%, 41%) " class = " box has-background-light">
