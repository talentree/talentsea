    ...
    render() {
        return html`            
            ...
            <div class = " columns is-mobile is-centered ">   
                <div class = " column is-11 ">
                    <p class = " subtitle is-size-4 has-text-justified ">La vostra squadra ha il comando di una nave con la strumentazione ridotta al minimo: motore, timone, mappa,  il goniometro, e … la testa.</p>
                    <p class = " subtitle is-size-4 has-text-justified ">L’obiettivo è arrivare in un porto sicuro: per farlo dovrete calcolare la rotta  e mantenerla risparmiando carburante, perché il vento, le correnti marine e le imprecisioni degli strumenti vi potranno portare fuori rotta.</p>
                    <p class = " subtitle is-size-4 has-text-justified ">Riuscirete ad arrivare per primi a destinazione? O, almeno, riuscirete ad arrivare?</p> 
                    <hr>
                </div>
            </div>
            <div class = " columns is-mobile is-centered ">
