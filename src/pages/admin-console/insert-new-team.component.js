...
export class InsertNewTeamComponent extends NavElement {
      ...
      <div class=" columns is-12 has-text-centered">
        <div class="column is-5">
          <input
            ...
            type="text"
            @input="${(e) => this.changedTeamName(e.target.value)}"
            .value="${this.teamName}"
        ...
        <div class="column is-5">
          <input
            class="input is-link"
            type="text"
            @input="${(e) => this.changedTeamColor(e.target.value)}"
            .value="${this.teamColor}"
            placeholder="Colore della nave"
          />
        </div>
        <div class="column is-5">
          <input
            class="input is-link"
            type="text"
            @input="${(e) => this.changedTeamPassword(e.target.value)}"
            .value="${this.teamPassword}"
  ...
  changedTeamColor(color) {
    this.teamColor = color;
    let e = new CustomEvent('colorChanged', { detail: this.teamColor });
    this.dispatchEvent(e);
  }
